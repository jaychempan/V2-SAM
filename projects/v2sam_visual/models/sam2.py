...
class SAM2(BaseModule):
    def __init__(
        ...
        hydra_overrides = [
            ...
            "++model._target_=projects.v2sam.models.predictor.SAM2VideoPredictor",
        ]
    ...
    def get_sam2_embeddings(self, images, prompt_images):
        return self.sam2_model.init_state(images, prompt_images)

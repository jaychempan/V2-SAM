...
class SAM2Base(_SAM2Base):
    ...
    def _forward_sam_heads(
        ...
        #     if prompt_embd.size(0) < dense_embeddings.size(0):
        #         repeat_times = dense_embeddings.size(0) // prompt_embd.size(0)
        #         prompt_embd = prompt_embd.repeat(repeat_times, 1, 1, 1)
        #     # print(dense_embeddings.size())
        #     # print(prompt_embd.size())
        #     assert dense_embeddings.size(0) == prompt_embd.size(0)
        #     assert dense_embeddings.size(2) == prompt_embd.size(2)
        #     dense_embeddings = torch.cat([dense_embeddings, prompt_embd], dim=1)

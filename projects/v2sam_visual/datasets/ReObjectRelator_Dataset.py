...
class VideoObjectRelatorDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        prompt_masklents = torch.from_numpy(prompt_masklents).permute(3, 0, 1, 2) # (n_obj, n_frames, h, w)
        prompt_masklents = self._reshape_mask(prompt_masklents.flatten(0, 1))  # (n_obj_total, h, w)
